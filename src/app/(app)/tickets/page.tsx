        ...
        {active ? (
            ...
            <header className="flex items-start justify-between gap-3">
              <div>
                ...
                <div className="text-xs text-gray-500 mt-1">
                  ...
                  <span className="font-medium">{active.priority}</span>
                  {active.dueDateSuggested &&
                    ` · Requested: ${active.dueDateSuggested}`}
                </div>
              </div>
              ...
              <section className="rounded-lg border p-3">
                ...
                <div className="space-y-2">
                  {proposed.map((p, idx) => (
                    <div
                      key={p.id}
                      className="grid grid-cols-1 md:grid-cols-[1fr_200px_80px] gap-2 rounded-lg border p-3 hover:bg-gray-50"
                    >
                      <div>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-500">
              Tickets will appear in the sidebar as they're submitted
            </p>
          </div>
        )}
      </main>
