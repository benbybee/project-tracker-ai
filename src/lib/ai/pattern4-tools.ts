...
export const pattern4Tools = [
  {
    ...
    description:
      'Create a new 90-day sprint plan with initial weeks and opportunities.',
    parameters: z.object({
      name: z
        .string()
        .describe('Name of the sprint (e.g., "Q1 Growth Sprint")'),
      ...
      weeks: z
        ...
        .optional()
        .describe('Optional list of week themes'),
      opportunities: z
        .array(
          z.object({
            name: z.string(),
        ...
        .optional()
        .describe('Optional list of initial opportunities'),
    }),
  },
  {
    name: 'rebalance_week',
    ...
    parameters: z.object({
      ...
      action: z
        .enum(['push_tasks', 'pull_tasks', 'reprioritize'])
        .describe('Type of rebalancing action'),
      taskIds: z
        .array(z.string())
        .optional()
      ...
      targetWeekIndex: z
        .number()
        .optional()
        .describe('Target week to move tasks to'),
  ...
  },
  {
    ...
    description:
      'Analyze an opportunity for viability, risks, and resource requirements.',
    parameters: z.object({
      opportunityId: z.string().describe('ID of the opportunity to analyze'),
      aspects: z
        .array(z.enum(['viability', 'risks', 'resources', 'roi']))
        .optional(),
    }),
  },
  {
    ...
    parameters: z.object({
      ...
      targetOpportunityId: z
        .string()
        .optional()
        .describe('Target opportunity ID'),
    }),
  },
  {
    name: 'suggest_priorities',
    description:
      'Suggest task prioritization based on opportunity value and deadlines.',
    parameters: z.object({
      sprintId: z.string().describe('ID of the active sprint'),
      focusArea: z
        .string()
        .optional()
        .describe('Specific area to focus on (e.g., "revenue", "speed")'),
    }),
  },
];
